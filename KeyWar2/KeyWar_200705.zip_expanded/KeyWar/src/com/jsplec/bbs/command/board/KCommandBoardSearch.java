...
public class KCommandBoardSearch implements KCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(request.getParameter("searchCategory") == null || request.getParameter("searchCategory").equals("") ||
			...
			ArrayList<KDtoBoard> kdto = dao.list(page);
			...
			ArrayList<KDtoBoard> kdto = dao.search(searchCategory, searchWord ,page);
