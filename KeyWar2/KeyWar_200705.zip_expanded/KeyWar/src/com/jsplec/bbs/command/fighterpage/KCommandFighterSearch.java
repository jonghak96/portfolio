...
public class KCommandFighterSearch implements KCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(request.getParameter("searchCategory") == null || request.getParameter("searchCategory").equals("") ||
			...
			ArrayList<KDtoMember> kdto = dao.list(page);
			...
			ArrayList<KDtoMember> kdto = dao.search(searchCategory, searchWord ,page);
