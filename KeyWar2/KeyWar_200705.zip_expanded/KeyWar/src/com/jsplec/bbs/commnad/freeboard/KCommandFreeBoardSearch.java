...
public class KCommandFreeBoardSearch implements KCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(request.getParameter("searchCategory") == null || request.getParameter("searchCategory").equals("") ||
			...
			ArrayList<KDtoFreeBoard> kdto = dao.list(page);
			...
			ArrayList<KDtoFreeBoard> kdto = dao.search(searchCategory, searchWord ,page);
